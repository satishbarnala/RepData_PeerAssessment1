...
Mean total number of steps taken per day are `r meanTotalStepsPerDay` and median is `r medianTotalStepsPerDay`
...
on average across all the days in the dataset, the interval with maximum number of steps is: `r maxInt`
...
```
After filling missing values, mean total number of steps taken per day is: `r meanTotalStepsPerDay1` and median is: `r medianTotalStepsPerDay1`

Mean remained same at `r meanTotalStepsPerDay1` and median is `r medianTotalStepsPerDay1` as compared to `r medianTotalStepsPerDay`
